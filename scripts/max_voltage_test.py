...
Uso:
    python scripts/max_voltage_test.py [--xml RUTA_AL_XML]
"""
import numpy as np
import time
import sys
...
def run_max_voltage_test(xml=None):
    ...
    env = PendulumEnv(xml_file=xml, render_mode="human", max_steps=1000)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--xml", type=str, default="models/pendulum_high_quality.xml", help="Ruta al archivo XML del modelo")
